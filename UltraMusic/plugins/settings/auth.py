...
from UltraMusic.helpers import admin_check, command, is_admin, utils


@app.on_message(command(["تصريح", "الغاء_التصريح"]) & filters.group & ~app.bl_users)
@lang.language()
@admin_check
...
@app.on_message(command(["قائمة_التصريح"]) & filters.group & ~app.bl_users)
@lang.language()
@admin_check
...
@app.on_message(command(["تحديث_المشرفين"]) & filters.group & ~app.bl_users)
@lang.language()
